...
class StoryMenuState extends MusicBeatState
{
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		var newImage:FlxGraphic = Paths.image('menus/story/menudifficulties/' + Paths.formatToSongPath(diff));
	...
	function changeWeek(change:Int = 0):Void
	{
		...
		if(assetName == null || assetName.length < 1) {
			...
			bgSprite.loadGraphic(Paths.image('menus/story/menubackgrounds/menu_' + assetName));
		}
