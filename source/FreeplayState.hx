...
class FreeplayState extends MusicBeatState
{
	...
	private var trackPlayingig:Bool = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (curSelected == 17 || curSelected == 18 || curSelected == 19 || curSelected == 20 || curSelected == 21 || curSelected == 32) {
			diffText.visible = true;
		} else diffText.visible = false;
