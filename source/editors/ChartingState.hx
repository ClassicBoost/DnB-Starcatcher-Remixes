...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Opponent Damage', "The opponent can hurt you if enabled!\n\nValue 1: Damage\nValue 2: Health cap (set to 0 to kill)"],
	...
	**/
	...
	override function create()
	{
		...
		var eventIcon:FlxSprite = new FlxSprite(-GRID_SIZE - 5, -90).loadGraphic(Paths.image('menus/chart/eventArrow'));
		...
		quant = new AttachedSprite('menus/chart/chart_quant','chart_quant');
		...
		\n
		\nMISC
		\nEsc - Test your chart inside Chart Editor (WIP)
	...
	*/
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		if(daSus != null) { //Common note
			...
			note.loadGraphic(Paths.image('menus/chart/eventArrow'));
