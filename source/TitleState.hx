...
class TitleState extends MusicBeatState
{
	...
	public static var justbecauseIcan:Bool = true;
	...
	override public function create():Void
	{
		...
		// IGNORE THIS!!!
		titleJSON = Json.parse(Paths.getTextFromFile('images/menus/title/gfDanceTitle.json'));
		...
		#else
		if(FlxG.save.data.flashing == null && !FlashingState.leftState || justbecauseIcan == true) {
			FlxTransitionableState.skipNextTransIn = true;
			FlxTransitionableState.skipNextTransOut = true;
			justbecauseIcan = false;
	...
	function startIntro()
	{
		...
		var path = "mods/" + Paths.currentModDirectory + "/images/menus/title/titleEnter.png";
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "mods/images/menus/title/titleEnter.png";
		}
		//trace(path, FileSystem.exists(path));
		if (!FileSystem.exists(path)){
			path = "assets/images/menus/title/titleEnter.png";
		}
		//trace(path, FileSystem.exists(path));
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 4:
					...
					addMoreText('CaioJ', 15);
					addMoreText('PurPoly', 15);
				//	ngSpr.visible = true;
				case 5:
					deleteCoolText();
				//	ngSpr.visible = false;
				case 6:
					createCoolText(['Starcatcher created by'], -40);
				case 8:
