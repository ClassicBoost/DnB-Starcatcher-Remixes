...
class ClientPrefs {
	...
	// Modded Specific
	public static var opponentSplashes:Bool = false;
	...
	public static var allowModcharts:Bool = true;
	public static var longhealthbar:Bool = false;
	public static var judgementstuff:Bool = true;
	public static var bfmodelol:Bool = false;
	public static var betterIconBop:Bool = false;
	public static var lowHPeffects:Bool = true;

	// saving system
	public static var unlockedRecursed:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.allowModcharts = allowModcharts;
		FlxG.save.data.longhealthbar = longhealthbar;
		FlxG.save.data.bfmodelol = bfmodelol;
		FlxG.save.data.betterIconBop = betterIconBop;
		FlxG.save.data.lowHPeffects = lowHPeffects;

		FlxG.save.data.unlockedRecursed = unlockedRecursed;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.allowModcharts != null) {
			allowModcharts = FlxG.save.data.allowModcharts;
		}
		if(FlxG.save.data.longhealthbar != null) {
			longhealthbar = FlxG.save.data.longhealthbar;
		}
		if(FlxG.save.data.bfmodelol != null) {
			bfmodelol = FlxG.save.data.bfmodelol;
		}
		if(FlxG.save.data.betterIconBop != null) {
			betterIconBop = FlxG.save.data.betterIconBop;
		}
		if(FlxG.save.data.lowHPeffects != null) {
			lowHPeffects = FlxG.save.data.lowHPeffects;
		}
		if(FlxG.save.data.unlockedRecursed != null) {
			unlockedRecursed = FlxG.save.data.unlockedRecursed;
		}
