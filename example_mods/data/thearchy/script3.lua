...
local spin = true;
local arrowMoveX = 600;
local arrowMoveY = 200;
...
function onUpdate(elapsed)
    ...
    currentBeat = (songPos / 1000) * (bpm / 169)
    if spin == true and getPropertyFromClass('ClientPrefs', 'allowModcharts') == true and difficulty == 1 then 
        for i = 0,7 do 
